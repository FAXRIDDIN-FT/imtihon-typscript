    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Не удалось загрузить драмы. Попробуйте позже.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Глубокие и эмоциональные истории, которые трогают душу
          </p>
        </div>
      </div>
        ...
        {isPending && (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">Загружаем драмы...</p>
            </div>
          </div>
        )}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-200">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <input
                      ...
                      className="w-20 px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
