    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Не удалось загрузить популярные фильмы. Попробуйте позже.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Самые популярные и обсуждаемые фильмы на данный момент
          </p>
        </div>
      </div>
        ...
        {isPending && (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">Загружаем популярные фильмы...</p>
            </div>
          </div>
        )}
