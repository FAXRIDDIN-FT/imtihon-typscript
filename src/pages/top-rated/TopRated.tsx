    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Не удалось загрузить фильмы с высоким рейтингом. Попробуйте позже.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center mb-4">
            <Star className="w-12 h-12 text-white mr-4 fill-current" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              Лучшие по рейтингу
            </h1>
          </div>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Фильмы с самыми высокими оценками зрителей и критиков
          </p>
        </div>
      </div>
        ...
        {isPending && (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">Загружаем лучшие фильмы...</p>
            </div>
          </div>
        )}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-200">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <input
                      ...
                      className="w-20 px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                    />
